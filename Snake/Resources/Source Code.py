...
speed_txt = open("Resources/speed.txt", "r")
SPEED = speed_txt.read()
if SPEED == "":
    SPEED = 6
else:
    SPEED = int(SPEED)
...
class SnakeGame:
    ...
    def _update_ui(self):
        ...
        self.display.blit(text2, [500, 5])

        text3 = font.render("Speed: " + str(SPEED), True, Constant.GREEN.value)
        self.display.blit(text3, [300, 5])
